...
describe('Service Tests', () => {
    ...
    describe('MoneyNg Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MoneyNgService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/monies';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MoneyNg', () => {

                let entity: MoneyNg;
                service.find(123).subscribe((_entity: MoneyNg) => {
                    entity = _entity;
                });
