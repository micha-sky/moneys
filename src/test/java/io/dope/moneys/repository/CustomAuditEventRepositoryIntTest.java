...
import io.dope.moneys.config.audit.AuditEventConverter;
import io.dope.moneys.domain.PersistentAuditEvent;
...
import static io.dope.moneys.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
